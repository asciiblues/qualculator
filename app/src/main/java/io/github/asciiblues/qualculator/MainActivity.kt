...
import io.github.asciiblues.qualculator.ui.theme.EMICalculatorTheme
...
class MainActivity : ComponentActivity() {
        ...
        setContent {
            EMICalculatorTheme {
                ...
                Scaffold(
                        ...
                        NavigationBar {
                            ...
                            NavigationBarItem(
                                ...
                                icon = {
                                    if (isConverter) {
                                        Icon(
                                            painterResource(R.drawable.baseline_drive_file_move_24),
                                            contentDescription = "converter"
                                        )
                                    } else {
                                        Icon(
                                            painterResource(R.drawable.outline_drive_file_move_24),
                                            contentDescription = "converter"
                                        )
                                    }
                                },
                    ...
                    Box(modifier = Modifier.padding(innerPadding)) { // Wrap content in Box to respect padding
                        mapp(modifier = Modifier.padding(innerPadding), snackbarHostState, scope)
                    }
                }
            }
        }
    ...
    fun mapp(
        ...
        //it is for the More Calculator Tools
        if (isClaerAll1) {
            LaunchedEffect(Unit) {
                scope.launch {
                    isConverter = false
                                                                    ...
                                                                    Card {
                                                                        Column(
                                                                            ...
                                                                            val intent = remember {
                                                                                Intent(
                                                                                    Intent.ACTION_VIEW,
                                                                                    Uri.parse("https://github.com/asciiblues/Data-Decimal-System-vs-Binary-/blob/main/README.md")
                                                                                )
                                                                            }
                                                                            ElevatedButton(
                                                                                onClick = {
